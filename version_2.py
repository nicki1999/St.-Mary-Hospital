...
df_jennifer = df[df['Surgeon'] == 'Mutch, Jennifer']
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        data = [["Alice", "25", "New York"],
                ["Bob", "30", "London"],
                [str(jennifer_total_shoulder_count), str(count), str("{:.2f}".format((count/jennifer_total_shoulder_count)*100)),
        ...
        header_cell1 = QTableWidgetItem("Jennifer Mutch")
